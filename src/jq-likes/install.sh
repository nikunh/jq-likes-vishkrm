...
# Install jq from official GitHub release (prebuilt binary)
JQ_VERSION="1.7.1"
JQ_URL="https://github.com/jqlang/jq/releases/download/jq-${JQ_VERSION}/jq-linux64"
INSTALL_DIR="/usr/local/bin"

curl -fsSL -o "$INSTALL_DIR/jq" "$JQ_URL"
chmod +x "$INSTALL_DIR/jq"
echo "jq installed: $($INSTALL_DIR/jq --version)"
